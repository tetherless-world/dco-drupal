...
<div id="community" class="main-content row nested">
    ...
    <?php endif; ?>
		...
		<div style="width: 300px;float: right; clear: none;" >
			...
			<p style="text-align: center;margin-top: 54px;"><span style="font-size: 85%;">The content on this page is moderated by the Deep Energy Community. For questions or concerns, please contact the administrator at <a href="mailto:demoderator@deepcarbon.net">DEModerator@deepcarbon.net</a></span></p>
			</div>
			</div>
